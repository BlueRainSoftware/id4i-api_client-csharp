...
${nuget_cmd} install src/BlueRain.ID4i/packages.config -o packages;
...
echo "[INFO] Run 'mcs' to build bin/BlueRain.ID4i.dll"
...
then
  ...
  echo "[INFO] bin/BlueRain.ID4i.dll was created successfully"
fi
