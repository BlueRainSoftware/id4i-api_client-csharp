...
namespace BlueRain.ID4i.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ServiceCosts :  IEquatable<ServiceCosts>, IValidatableObject
    {
        /// <summary>
        ...
        public ServiceCosts(Dictionary<string, float?> Listing = default(Dictionary<string, float?>))
        {
