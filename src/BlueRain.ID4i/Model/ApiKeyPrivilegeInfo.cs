...
namespace BlueRain.ID4i.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ApiKeyPrivilegeInfo :  IEquatable<ApiKeyPrivilegeInfo>, IValidatableObject
    {
        /// <summary>
        ...
        public ApiKeyPrivilegeInfo(string HelpText = default(string), bool? Id4nAssociated = default(bool?), string Name = default(string))
        {
