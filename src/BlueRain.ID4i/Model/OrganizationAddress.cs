...
namespace BlueRain.ID4i.Model
{
    ...
    public partial class OrganizationAddress :  IEquatable<OrganizationAddress>, IValidatableObject
    {
        ...
        IEnumerable<System.ComponentModel.DataAnnotations.ValidationResult> IValidatableObject.Validate(ValidationContext validationContext)
        {
            ...
            if(this.CompanyName != null && this.CompanyName.Length > 254)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for CompanyName, length must be less than 254.", new [] { "CompanyName" });
            }
            ...
            if(this.Firstname != null && this.Firstname.Length > 254)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for Firstname, length must be less than 254.", new [] { "Firstname" });
            }
            ...
            if(this.Lastname != null && this.Lastname.Length > 254)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for Lastname, length must be less than 254.", new [] { "Lastname" });
            }
            ...
            if(this.Street != null && this.Street.Length > 254)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for Street, length must be less than 254.", new [] { "Street" });
            }

            // Street (string) minLength
            if(this.Street != null && this.Street.Length < 3)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for Street, length must be greater than 3.", new [] { "Street" });
            }

            // PostCode (string) maxLength
            if(this.PostCode != null && this.PostCode.Length > 40)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for PostCode, length must be less than 40.", new [] { "PostCode" });
            }

            // PostCode (string) minLength
            if(this.PostCode != null && this.PostCode.Length < 2)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for PostCode, length must be greater than 2.", new [] { "PostCode" });
            }

            // City (string) maxLength
            if(this.City != null && this.City.Length > 99)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for City, length must be less than 99.", new [] { "City" });
            }
            ...
            if(this.Telephone != null && this.Telephone.Length > 99)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for Telephone, length must be less than 99.", new [] { "Telephone" });
            }
