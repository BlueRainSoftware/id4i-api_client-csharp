...
namespace BlueRain.ID4i.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class Visibility :  IEquatable<Visibility>, IValidatableObject
    {
        /// <summary>
        ...
        public Visibility(bool? _Public = default(bool?), List<long?> SharedOrganizationIds = default(List<long?>))
        {
