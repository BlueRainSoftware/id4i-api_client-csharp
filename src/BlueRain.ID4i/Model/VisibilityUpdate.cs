...
namespace BlueRain.ID4i.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class VisibilityUpdate :  IEquatable<VisibilityUpdate>, IValidatableObject
    {
        /// <summary>
        ...
        public VisibilityUpdate(bool? _Public = default(bool?), List<long?> SharedWithOrganizationIds = default(List<long?>))
        {
