...
namespace BlueRain.ID4i.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class OwnedDocument :  IEquatable<OwnedDocument>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="OwnedDocument" /> class.
        /// </summary>
        /// <param name="Filename">File Name.</param>
        /// <param name="MimeType">Mime Type.</param>
        /// <param name="Visibility">Visibility configuration.</param>
        public OwnedDocument(string Filename = default(string), string MimeType = default(string), Visibility Visibility = default(Visibility))
        {
        ...
        {
            return this.Equals(input as OwnedDocument);
        }

        /// <summary>
        /// Returns true if OwnedDocument instances are equal
        /// </summary>
        /// <param name="input">Instance of OwnedDocument to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OwnedDocument input)
        {
            if (input == null)
                return false;
