...
namespace BlueRain.ID4i.Model
{
    ...
    public partial class Guid :  IEquatable<Guid>
    {
        ...
        /// <param name="Properties">The properties of the organization.</param>
        public Guid(PhysicalStateEnum? PhysicalState = default(PhysicalStateEnum?), Dictionary<string, string> Properties = default(Dictionary<string, string>))
        {
        ...
        /// </summary>
        /// <value>The properties of the organization</value>
