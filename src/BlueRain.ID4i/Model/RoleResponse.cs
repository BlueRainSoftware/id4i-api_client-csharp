...
namespace BlueRain.ID4i.Model
{
    ...
    public partial class RoleResponse :  IEquatable<RoleResponse>
    {
        ...
        public RoleResponse(List<Role> Elements = default(List<Role>), int? Limit = default(int?), int? Offset = default(int?), int? Total = default(int?))
        {
            // to ensure "Elements" is required (not null)
            if (Elements == null)
            {
                throw new InvalidDataException("Elements is a required property for RoleResponse and cannot be null");
            }
            else
            {
            ...
            if (Limit == null)
            {
                throw new InvalidDataException("Limit is a required property for RoleResponse and cannot be null");
            }
            else
            {
                this.Limit = Limit;
            ...
            if (Offset == null)
            {
                throw new InvalidDataException("Offset is a required property for RoleResponse and cannot be null");
            }
            else
            {
                this.Offset = Offset;
