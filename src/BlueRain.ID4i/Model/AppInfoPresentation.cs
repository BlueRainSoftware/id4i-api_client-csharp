...
namespace BlueRain.ID4i.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class AppInfoPresentation :  IEquatable<AppInfoPresentation>, IValidatableObject
    {
        /// <summary>
        ...
        public AppInfoPresentation(string Branch = default(string), string CommitTime = default(string), string Name = default(string), string Revision = default(string), string Version = default(string))
        {
            this.Branch = Branch;
