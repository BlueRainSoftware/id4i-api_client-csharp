...
namespace BlueRain.ID4i.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class CreateLogisticCollectionRequest :  IEquatable<CreateLogisticCollectionRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateLogisticCollectionRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CreateLogisticCollectionRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateLogisticCollectionRequest" /> class.
        /// </summary>
        ...
        public CreateLogisticCollectionRequest(string Label = default(string), int? Length = default(int?), long? OrganizationId = default(long?))
        {
            // to ensure "Length" is required (not null)
            if (Length == null)
            {
                throw new InvalidDataException("Length is a required property for CreateLogisticCollectionRequest and cannot be null");
            }
            else
            {
                this.Length = Length;
            ...
            {
                throw new InvalidDataException("OrganizationId is a required property for CreateLogisticCollectionRequest and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as CreateLogisticCollectionRequest);
        }

        /// <summary>
        /// Returns true if CreateLogisticCollectionRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of CreateLogisticCollectionRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CreateLogisticCollectionRequest input)
        {
            if (input == null)
                return false;
