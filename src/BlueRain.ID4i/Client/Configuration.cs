...
namespace BlueRain.ID4i.Client
{
    ...
    public class Configuration : IReadableConfiguration
    {
        ...
        {
            UserAgent = "Swagger-Codegen/0.9.8/csharp";
        ...
        public Configuration(
            ...
            int timeout = 100000,
            string userAgent = "Swagger-Codegen/0.9.8/csharp"
        ...
        public static String ToDebugReport()
        {
            ...
            report += "    Version of the API: 0.9.8-SNAPSHOT\n";
            report += "    SDK Package Version: 0.9.8\n";
