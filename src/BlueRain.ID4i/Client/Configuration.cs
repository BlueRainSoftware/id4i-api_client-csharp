...
namespace BlueRain.ID4i.Client
{
    ...
    public class Configuration : IReadableConfiguration
    {
        ...
        {
            UserAgent = "Swagger-Codegen/0.7.3/csharp";
        ...
        public Configuration(
            ...
            int timeout = 100000,
            string userAgent = "Swagger-Codegen/0.7.3/csharp"
        ...
        public static String ToDebugReport()
        {
            ...
            report += "    Version of the API: 0.7.3-SNAPSHOT\n";
            report += "    SDK Package Version: 0.7.3\n";
