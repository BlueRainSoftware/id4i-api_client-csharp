...
namespace BlueRain.ID4i.Client
{
    ...
    public partial class ApiClient
    {
        ...
        public ApiClient()
        {
            Configuration = BlueRain.ID4i.Client.Configuration.Default;
            RestClient = new RestClient("https://backend.id4i.de");
            RestClient.IgnoreResponseStatusCode = true;
        }

        /// <summary>
        /// Initializes a new instance of the <see cref="ApiClient" /> class
        /// with default base path (https://backend.id4i.de).
        /// </summary>
        /// <param name="config">An instance of Configuration.</param>
        public ApiClient(Configuration config)
        {
            Configuration = config ?? BlueRain.ID4i.Client.Configuration.Default;
