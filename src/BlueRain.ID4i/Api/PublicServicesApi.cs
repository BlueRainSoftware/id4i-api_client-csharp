...
namespace BlueRain.ID4i.Api
{
    ...
    #region Synchronous Operations
        ...
        ApiResponse<PaginatedResponseOfHistoryItem> ListPublicHistoryWithHttpInfo (string id4n, int? offset = null, int? limit = null);
        /// <summary>
        ...
        ApiResponse<WhoIsResponse> ResolveWhoIsEntryWithHttpInfo (string id4n);
            ...
            System.Threading.Tasks.Task<PaginatedResponseOfHistoryItem> ListPublicHistoryAsync (string id4n, int? offset = null, int? limit = null);
            ...
            /// <returns>Task of ApiResponse (PaginatedResponseOfHistoryItem)</returns>
                System.Threading.Tasks.Task<ApiResponse<PaginatedResponseOfHistoryItem>> ListPublicHistoryAsyncWithHttpInfo (string id4n, int? offset = null, int? limit = null);
                /// <summary>
                /// Read public organization information
                /// </summary>
                /// <remarks>
    ...
    public partial class PublicServicesApi : IPublicServicesApi
        ...
        /// <param name="limit">The maximum count of returned elements (optional)</param>
        /// <returns>PaginatedResponseOfHistoryItem</returns>
            public PaginatedResponseOfHistoryItem ListPublicHistory (string id4n, int? offset = null, int? limit = null)
            {
        ApiResponse<PaginatedResponseOfHistoryItem> localVarResponse = ListPublicHistoryWithHttpInfo(id4n, offset, limit);
            return localVarResponse.Data;
            }
        ...
        /// <param name="limit">The maximum count of returned elements (optional)</param>
        /// <returns>ApiResponse of PaginatedResponseOfHistoryItem</returns>
            public ApiResponse< PaginatedResponseOfHistoryItem > ListPublicHistoryWithHttpInfo (string id4n, int? offset = null, int? limit = null)
            {
                    // verify the required parameter 'id4n' is set
                    if (id4n == null)
            ...
            /// <param name="limit">The maximum count of returned elements (optional)</param>
            /// <returns>Task of PaginatedResponseOfHistoryItem</returns>
            public async System.Threading.Tasks.Task<PaginatedResponseOfHistoryItem> ListPublicHistoryAsync (string id4n, int? offset = null, int? limit = null)
                {
            ApiResponse<PaginatedResponseOfHistoryItem> localVarResponse = await ListPublicHistoryAsyncWithHttpInfo(id4n, offset, limit);
                return localVarResponse.Data;
            ...
            /// <param name="limit">The maximum count of returned elements (optional)</param>
            /// <returns>Task of ApiResponse (PaginatedResponseOfHistoryItem)</returns>
                public async System.Threading.Tasks.Task<ApiResponse<PaginatedResponseOfHistoryItem>> ListPublicHistoryAsyncWithHttpInfo (string id4n, int? offset = null, int? limit = null)
                {
                        // verify the required parameter 'id4n' is set
                        if (id4n == null)
                        throw new ApiException(400, "Missing required parameter 'id4n' when calling PublicServicesApi->ListPublicHistory");
