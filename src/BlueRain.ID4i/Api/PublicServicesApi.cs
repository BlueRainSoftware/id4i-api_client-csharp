...
namespace BlueRain.ID4i.Api
{
    ...
    #region Synchronous Operations
        ...
        ApiResponse<List<Route>> GetWebRoutesWithHttpInfo (string id4n);
        /// <summary>
            /// Forward
            /// </summary>
        /// <remarks>
        ...
        ApiResponse<Organization> ReadOrganizationInfoWithHttpInfo (long? organizationId);
        /// <summary>
        ...
        ApiResponse<WhoIsResponse> ResolveWhoIsEntryWithHttpInfo (string id4n);
            ...
            System.Threading.Tasks.Task<List<Route>> GetWebRoutesAsync (string id4n);
            ...
            /// <returns>Task of ApiResponse (List&lt;Route&gt;)</returns>
                System.Threading.Tasks.Task<ApiResponse<List<Route>>> GetWebRoutesAsyncWithHttpInfo (string id4n);
                /// <summary>
                /// Forward
                /// </summary>
                /// <remarks>
            ...
            System.Threading.Tasks.Task<Organization> ReadOrganizationInfoAsync (long? organizationId);
            ...
            /// <returns>Task of ApiResponse (Organization)</returns>
                System.Threading.Tasks.Task<ApiResponse<Organization>> ReadOrganizationInfoAsyncWithHttpInfo (long? organizationId);
                /// <summary>
                /// Read document contents
                /// </summary>
                /// <remarks>
    ...
    public partial class PublicServicesApi : IPublicServicesApi
        ...
        /// <param name="id4n">id4n</param>
        /// <returns>List&lt;Route&gt;</returns>
            public List<Route> GetWebRoutes (string id4n)
            {
        ApiResponse<List<Route>> localVarResponse = GetWebRoutesWithHttpInfo(id4n);
            return localVarResponse.Data;
            }
        ...
        /// <param name="id4n">id4n</param>
        /// <returns>ApiResponse of List&lt;Route&gt;</returns>
            public ApiResponse< List<Route> > GetWebRoutesWithHttpInfo (string id4n)
            {
                    // verify the required parameter 'id4n' is set
                    if (id4n == null)
                    throw new ApiException(400, "Missing required parameter 'id4n' when calling PublicServicesApi->GetWebRoutes");
            ...
            if (ExceptionFactory != null)
            {
            Exception exception = ExceptionFactory("GetWebRoutes", localVarResponse);
            if (exception != null) throw exception;
            }
            ...
            /// <param name="id4n">id4n</param>
            /// <returns>Task of List&lt;Route&gt;</returns>
            public async System.Threading.Tasks.Task<List<Route>> GetWebRoutesAsync (string id4n)
                {
            ApiResponse<List<Route>> localVarResponse = await GetWebRoutesAsyncWithHttpInfo(id4n);
                return localVarResponse.Data;
            ...
            /// <param name="id4n">id4n</param>
            /// <returns>Task of ApiResponse (List&lt;Route&gt;)</returns>
                public async System.Threading.Tasks.Task<ApiResponse<List<Route>>> GetWebRoutesAsyncWithHttpInfo (string id4n)
                {
                        // verify the required parameter 'id4n' is set
                        if (id4n == null)
                        throw new ApiException(400, "Missing required parameter 'id4n' when calling PublicServicesApi->GetWebRoutes");
        ...
        /// <param name="organizationId">Organization ID</param>
        /// <returns>Organization</returns>
            public Organization ReadOrganizationInfo (long? organizationId)
            {
        ...
        /// <param name="organizationId">Organization ID</param>
        /// <returns>ApiResponse of Organization</returns>
            public ApiResponse< Organization > ReadOrganizationInfoWithHttpInfo (long? organizationId)
            {
                    // verify the required parameter 'organizationId' is set
                    if (organizationId == null)
            ...
            /// <param name="organizationId">Organization ID</param>
            /// <returns>Task of Organization</returns>
            public async System.Threading.Tasks.Task<Organization> ReadOrganizationInfoAsync (long? organizationId)
                {
            ...
            /// <param name="organizationId">Organization ID</param>
            /// <returns>Task of ApiResponse (Organization)</returns>
                public async System.Threading.Tasks.Task<ApiResponse<Organization>> ReadOrganizationInfoAsyncWithHttpInfo (long? organizationId)
                {
                        // verify the required parameter 'organizationId' is set
                        if (organizationId == null)
                        throw new ApiException(400, "Missing required parameter 'organizationId' when calling PublicServicesApi->ReadOrganizationInfo");
