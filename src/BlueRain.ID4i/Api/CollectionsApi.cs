...
namespace BlueRain.ID4i.Api
{
    ...
    #region Synchronous Operations
        ...
        ApiResponse<PaginatedResponseOfGuid> ListElementsOfCollectionWithHttpInfo (string id4n, int? offset = null, int? limit = null, string organizationId = null);
        /// <summary>
        ...
        ApiResponse<Object> UpdateCollectionWithHttpInfo (string id4n, GuidCollection request);
            ...
            System.Threading.Tasks.Task<PaginatedResponseOfGuid> ListElementsOfCollectionAsync (string id4n, int? offset = null, int? limit = null, string organizationId = null);
            ...
            /// <returns>Task of ApiResponse (PaginatedResponseOfGuid)</returns>
                System.Threading.Tasks.Task<ApiResponse<PaginatedResponseOfGuid>> ListElementsOfCollectionAsyncWithHttpInfo (string id4n, int? offset = null, int? limit = null, string organizationId = null);
                /// <summary>
                /// Patch ID4n properties
                /// </summary>
                /// <remarks>
    ...
    public partial class CollectionsApi : ICollectionsApi
        ...
        /// <param name="organizationId">The organization namespace. (optional)</param>
        /// <returns>PaginatedResponseOfGuid</returns>
            public PaginatedResponseOfGuid ListElementsOfCollection (string id4n, int? offset = null, int? limit = null, string organizationId = null)
            {
        ApiResponse<PaginatedResponseOfGuid> localVarResponse = ListElementsOfCollectionWithHttpInfo(id4n, offset, limit, organizationId);
            return localVarResponse.Data;
            }
        ...
        /// <param name="organizationId">The organization namespace. (optional)</param>
        /// <returns>ApiResponse of PaginatedResponseOfGuid</returns>
            public ApiResponse< PaginatedResponseOfGuid > ListElementsOfCollectionWithHttpInfo (string id4n, int? offset = null, int? limit = null, string organizationId = null)
            {
                    // verify the required parameter 'id4n' is set
                    if (id4n == null)
            ...
            /// <param name="organizationId">The organization namespace. (optional)</param>
            /// <returns>Task of PaginatedResponseOfGuid</returns>
            public async System.Threading.Tasks.Task<PaginatedResponseOfGuid> ListElementsOfCollectionAsync (string id4n, int? offset = null, int? limit = null, string organizationId = null)
                {
            ApiResponse<PaginatedResponseOfGuid> localVarResponse = await ListElementsOfCollectionAsyncWithHttpInfo(id4n, offset, limit, organizationId);
                return localVarResponse.Data;
            ...
            /// <param name="organizationId">The organization namespace. (optional)</param>
            /// <returns>Task of ApiResponse (PaginatedResponseOfGuid)</returns>
                public async System.Threading.Tasks.Task<ApiResponse<PaginatedResponseOfGuid>> ListElementsOfCollectionAsyncWithHttpInfo (string id4n, int? offset = null, int? limit = null, string organizationId = null)
                {
                        // verify the required parameter 'id4n' is set
                        if (id4n == null)
                        throw new ApiException(400, "Missing required parameter 'id4n' when calling CollectionsApi->ListElementsOfCollection");
