...
namespace BlueRain.ID4i.Api
{
    ...
    #region Synchronous Operations
        ...
        ApiResponse<PaginatedResponseOfGuidCollection> GetCollectionsWithHttpInfo (string id4n, string organizationId = null, int? offset = null, int? limit = null);
        /// <summary>
        ...
        /// <param name="organizationId">The organization namespace to resolve. (optional)</param>
        ...
        ApiResponse<Guid> GetGuidWithHttpInfo (string id4n, string organizationId = null);
        /// <summary>
        ...
        ApiResponse<Id4nPresentation> GetId4nWithHttpInfo (string id4n, string organizationId = null);
        /// <summary>
        ...
        ApiResponse<Object> UpdateGuidWithHttpInfo (string id4n, Guid request);
            ...
            System.Threading.Tasks.Task<PaginatedResponseOfGuidCollection> GetCollectionsAsync (string id4n, string organizationId = null, int? offset = null, int? limit = null);
            ...
            /// <returns>Task of ApiResponse (PaginatedResponseOfGuidCollection)</returns>
                System.Threading.Tasks.Task<ApiResponse<PaginatedResponseOfGuidCollection>> GetCollectionsAsyncWithHttpInfo (string id4n, string organizationId = null, int? offset = null, int? limit = null);
                /// <summary>
                /// Retrieve GUID information
                /// </summary>
                /// <remarks>
            ...
            System.Threading.Tasks.Task<Guid> GetGuidAsync (string id4n, string organizationId = null);
            ...
            /// <returns>Task of ApiResponse (Guid)</returns>
                System.Threading.Tasks.Task<ApiResponse<Guid>> GetGuidAsyncWithHttpInfo (string id4n, string organizationId = null);
                /// <summary>
                /// Get all aliases for the given GUID or Collection.
                /// </summary>
                /// <remarks>
            ...
            System.Threading.Tasks.Task<Id4nPresentation> GetId4nAsync (string id4n, string organizationId = null);
            ...
            /// <returns>Task of ApiResponse (Id4nPresentation)</returns>
                System.Threading.Tasks.Task<ApiResponse<Id4nPresentation>> GetId4nAsyncWithHttpInfo (string id4n, string organizationId = null);
                /// <summary>
                /// Retrieve ID4n properties
                /// </summary>
                /// <remarks>
            ...
            /// <param name="importGS1CodesRequest">The information how the MAPP codes should be imported and the list of MAPP codes</param>
            /// <returns>Task of void</returns>
            System.Threading.Tasks.Task ImportGS1CodesAsync (ImportGS1CodesRequest importGS1CodesRequest);
    ...
    public partial class GuidsApi : IGuidsApi
        ...
        /// <param name="limit">The maximum count of returned elements (optional)</param>
        /// <returns>PaginatedResponseOfGuidCollection</returns>
            public PaginatedResponseOfGuidCollection GetCollections (string id4n, string organizationId = null, int? offset = null, int? limit = null)
            {
        ApiResponse<PaginatedResponseOfGuidCollection> localVarResponse = GetCollectionsWithHttpInfo(id4n, organizationId, offset, limit);
            return localVarResponse.Data;
            }
        ...
        /// <param name="limit">The maximum count of returned elements (optional)</param>
        /// <returns>ApiResponse of PaginatedResponseOfGuidCollection</returns>
            public ApiResponse< PaginatedResponseOfGuidCollection > GetCollectionsWithHttpInfo (string id4n, string organizationId = null, int? offset = null, int? limit = null)
            {
                    // verify the required parameter 'id4n' is set
                    if (id4n == null)
            ...
            /// <param name="limit">The maximum count of returned elements (optional)</param>
            /// <returns>Task of PaginatedResponseOfGuidCollection</returns>
            public async System.Threading.Tasks.Task<PaginatedResponseOfGuidCollection> GetCollectionsAsync (string id4n, string organizationId = null, int? offset = null, int? limit = null)
                {
            ApiResponse<PaginatedResponseOfGuidCollection> localVarResponse = await GetCollectionsAsyncWithHttpInfo(id4n, organizationId, offset, limit);
                return localVarResponse.Data;
            ...
            /// <param name="limit">The maximum count of returned elements (optional)</param>
            /// <returns>Task of ApiResponse (PaginatedResponseOfGuidCollection)</returns>
                public async System.Threading.Tasks.Task<ApiResponse<PaginatedResponseOfGuidCollection>> GetCollectionsAsyncWithHttpInfo (string id4n, string organizationId = null, int? offset = null, int? limit = null)
                {
                        // verify the required parameter 'id4n' is set
                        if (id4n == null)
                        throw new ApiException(400, "Missing required parameter 'id4n' when calling GuidsApi->GetCollections");
        ...
        /// <param name="organizationId">The organization namespace to resolve. (optional)</param>
        /// <returns>Guid</returns>
            public Guid GetGuid (string id4n, string organizationId = null)
            {
        ApiResponse<Guid> localVarResponse = GetGuidWithHttpInfo(id4n, organizationId);
            return localVarResponse.Data;
            }
        ...
        /// <param name="organizationId">The organization namespace to resolve. (optional)</param>
        /// <returns>ApiResponse of Guid</returns>
            public ApiResponse< Guid > GetGuidWithHttpInfo (string id4n, string organizationId = null)
            {
                    // verify the required parameter 'id4n' is set
                    if (id4n == null)
            ...
            /// <param name="organizationId">The organization namespace to resolve. (optional)</param>
            /// <returns>Task of Guid</returns>
            public async System.Threading.Tasks.Task<Guid> GetGuidAsync (string id4n, string organizationId = null)
                {
            ApiResponse<Guid> localVarResponse = await GetGuidAsyncWithHttpInfo(id4n, organizationId);
                return localVarResponse.Data;
            ...
            /// <param name="organizationId">The organization namespace to resolve. (optional)</param>
            /// <returns>Task of ApiResponse (Guid)</returns>
                public async System.Threading.Tasks.Task<ApiResponse<Guid>> GetGuidAsyncWithHttpInfo (string id4n, string organizationId = null)
                {
                        // verify the required parameter 'id4n' is set
                        if (id4n == null)
                        throw new ApiException(400, "Missing required parameter 'id4n' when calling GuidsApi->GetGuid");
        ...
        /// <param name="organizationId">The organization namespace to resolve. (optional)</param>
        /// <returns>Id4nPresentation</returns>
            public Id4nPresentation GetId4n (string id4n, string organizationId = null)
            {
        ApiResponse<Id4nPresentation> localVarResponse = GetId4nWithHttpInfo(id4n, organizationId);
            return localVarResponse.Data;
            }
        ...
        /// <param name="organizationId">The organization namespace to resolve. (optional)</param>
        /// <returns>ApiResponse of Id4nPresentation</returns>
            public ApiResponse< Id4nPresentation > GetId4nWithHttpInfo (string id4n, string organizationId = null)
            {
                    // verify the required parameter 'id4n' is set
                    if (id4n == null)
            ...
            /// <param name="organizationId">The organization namespace to resolve. (optional)</param>
            /// <returns>Task of Id4nPresentation</returns>
            public async System.Threading.Tasks.Task<Id4nPresentation> GetId4nAsync (string id4n, string organizationId = null)
                {
            ApiResponse<Id4nPresentation> localVarResponse = await GetId4nAsyncWithHttpInfo(id4n, organizationId);
                return localVarResponse.Data;
            ...
            /// <param name="organizationId">The organization namespace to resolve. (optional)</param>
            /// <returns>Task of ApiResponse (Id4nPresentation)</returns>
                public async System.Threading.Tasks.Task<ApiResponse<Id4nPresentation>> GetId4nAsyncWithHttpInfo (string id4n, string organizationId = null)
                {
                        // verify the required parameter 'id4n' is set
                        if (id4n == null)
                        throw new ApiException(400, "Missing required parameter 'id4n' when calling GuidsApi->GetId4n");
        ...
        /// <param name="importGS1CodesRequest">The information how the MAPP codes should be imported and the list of MAPP codes</param>
        /// <returns></returns>
            public void ImportGS1Codes (ImportGS1CodesRequest importGS1CodesRequest)
            {
        ...
        /// <param name="importGS1CodesRequest">The information how the MAPP codes should be imported and the list of MAPP codes</param>
        /// <returns>ApiResponse of Object(void)</returns>
            public ApiResponse<Object> ImportGS1CodesWithHttpInfo (ImportGS1CodesRequest importGS1CodesRequest)
            {
                    // verify the required parameter 'importGS1CodesRequest' is set
                    if (importGS1CodesRequest == null)
                    throw new ApiException(400, "Missing required parameter 'importGS1CodesRequest' when calling GuidsApi->ImportGS1Codes");

            var localVarPath = "./api/v1/import/gs1";
            var localVarPathParams = new Dictionary<String, String>();
            var localVarQueryParams = new List<KeyValuePair<String, String>>();
            var localVarHeaderParams = new Dictionary<String, String>(Configuration.DefaultHeader);
            var localVarFormParams = new Dictionary<String, String>();
            ...
            localVarHeaderParams.Add("Accept", localVarHttpHeaderAccept);
                ...
                if (importGS1CodesRequest != null && importGS1CodesRequest.GetType() != typeof(byte[]))
                {
                localVarPostBody = Configuration.ApiClient.Serialize(importGS1CodesRequest); // http body (model) parameter
                }
                else
                {
                localVarPostBody = importGS1CodesRequest; // byte array
                }
            ...
            /// <param name="importGS1CodesRequest">The information how the MAPP codes should be imported and the list of MAPP codes</param>
            /// <returns>Task of void</returns>
            public async System.Threading.Tasks.Task ImportGS1CodesAsync (ImportGS1CodesRequest importGS1CodesRequest)
                {
            await ImportGS1CodesAsyncWithHttpInfo(importGS1CodesRequest);
            ...
            /// <param name="importGS1CodesRequest">The information how the MAPP codes should be imported and the list of MAPP codes</param>
            /// <returns>Task of ApiResponse</returns>
                public async System.Threading.Tasks.Task<ApiResponse<Object>> ImportGS1CodesAsyncWithHttpInfo (ImportGS1CodesRequest importGS1CodesRequest)
                {
                        // verify the required parameter 'importGS1CodesRequest' is set
                        if (importGS1CodesRequest == null)
                        throw new ApiException(400, "Missing required parameter 'importGS1CodesRequest' when calling GuidsApi->ImportGS1Codes");
