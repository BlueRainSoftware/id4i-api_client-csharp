...
namespace BlueRain.ID4i.Api
{
    ...
    #region Synchronous Operations
        ...
        ApiResponse<PaginatedResponseOfGuid> SearchByAliasWithHttpInfo (string alias, string aliasType, int? offset = null, int? limit = null);
            ...
            System.Threading.Tasks.Task<PaginatedResponseOfGuid> SearchByAliasAsync (string alias, string aliasType, int? offset = null, int? limit = null);
            ...
            /// <returns>Task of ApiResponse (PaginatedResponseOfGuid)</returns>
                System.Threading.Tasks.Task<ApiResponse<PaginatedResponseOfGuid>> SearchByAliasAsyncWithHttpInfo (string alias, string aliasType, int? offset = null, int? limit = null);
    ...
    public partial class AliasApi : IAliasApi
        ...
        /// <param name="limit">The maximum count of returned elements (optional)</param>
        /// <returns>PaginatedResponseOfGuid</returns>
            public PaginatedResponseOfGuid SearchByAlias (string alias, string aliasType, int? offset = null, int? limit = null)
            {
        ApiResponse<PaginatedResponseOfGuid> localVarResponse = SearchByAliasWithHttpInfo(alias, aliasType, offset, limit);
            return localVarResponse.Data;
            }
        ...
        /// <param name="limit">The maximum count of returned elements (optional)</param>
        /// <returns>ApiResponse of PaginatedResponseOfGuid</returns>
            public ApiResponse< PaginatedResponseOfGuid > SearchByAliasWithHttpInfo (string alias, string aliasType, int? offset = null, int? limit = null)
            {
                    // verify the required parameter 'alias' is set
                    if (alias == null)
            ...
            /// <param name="limit">The maximum count of returned elements (optional)</param>
            /// <returns>Task of PaginatedResponseOfGuid</returns>
            public async System.Threading.Tasks.Task<PaginatedResponseOfGuid> SearchByAliasAsync (string alias, string aliasType, int? offset = null, int? limit = null)
                {
            ApiResponse<PaginatedResponseOfGuid> localVarResponse = await SearchByAliasAsyncWithHttpInfo(alias, aliasType, offset, limit);
                return localVarResponse.Data;
            ...
            /// <param name="limit">The maximum count of returned elements (optional)</param>
            /// <returns>Task of ApiResponse (PaginatedResponseOfGuid)</returns>
                public async System.Threading.Tasks.Task<ApiResponse<PaginatedResponseOfGuid>> SearchByAliasAsyncWithHttpInfo (string alias, string aliasType, int? offset = null, int? limit = null)
                {
                        // verify the required parameter 'alias' is set
                        if (alias == null)
                        throw new ApiException(400, "Missing required parameter 'alias' when calling AliasApi->SearchByAlias");
