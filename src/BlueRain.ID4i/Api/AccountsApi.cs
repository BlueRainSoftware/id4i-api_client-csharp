...
namespace BlueRain.ID4i.Api
{
    ...
    #region Synchronous Operations
        ...
        ApiResponse<bool?> IsContractRequiredWithHttpInfo ();
        /// <summary>
            /// List roles
            /// </summary>
        /// <remarks>
        ...
        ApiResponse<Object> VerifyUserRegistrationWithHttpInfo (RegistrationVerificationTokenPresentation token);
            ...
            System.Threading.Tasks.Task<bool?> IsContractRequiredAsync ();
            ...
            /// <returns>Task of ApiResponse (bool?)</returns>
                System.Threading.Tasks.Task<ApiResponse<bool?>> IsContractRequiredAsyncWithHttpInfo ();
                /// <summary>
                /// List roles
                /// </summary>
                /// <remarks>
    ...
    public partial class AccountsApi : IAccountsApi
        ...
        /// <returns>ApiResponse of Object(void)</returns>
            ...
            /// <summary>
            /// Tells you whether your company needs to have a contract with BlueRain to be able to sign up On production systems, users must confirm that their organization has a valid contract for ID4i usage. It is not required on test and sandbox systems. 
            /// </summary>
            /// <exception cref="BlueRain.ID4i.Client.ApiException">Thrown when fails to make API call</exception>
        /// <returns>bool?</returns>
            public bool? IsContractRequired ()
            {
        ApiResponse<bool?> localVarResponse = IsContractRequiredWithHttpInfo();
            return localVarResponse.Data;
            }
            ...
            /// <exception cref="BlueRain.ID4i.Client.ApiException">Thrown when fails to make API call</exception>
        /// <returns>ApiResponse of bool?</returns>
            public ApiResponse< bool? > IsContractRequiredWithHttpInfo ()
            {

            var localVarPath = "./account/contractRequired";
            var localVarPathParams = new Dictionary<String, String>();
            var localVarQueryParams = new List<KeyValuePair<String, String>>();
            var localVarHeaderParams = new Dictionary<String, String>(Configuration.DefaultHeader);
            var localVarFormParams = new Dictionary<String, String>();
            ...
            if (ExceptionFactory != null)
            {
            Exception exception = ExceptionFactory("IsContractRequired", localVarResponse);
            if (exception != null) throw exception;
            }
                ...
                /// <exception cref="BlueRain.ID4i.Client.ApiException">Thrown when fails to make API call</exception>
            /// <returns>Task of bool?</returns>
            public async System.Threading.Tasks.Task<bool?> IsContractRequiredAsync ()
                {
            ApiResponse<bool?> localVarResponse = await IsContractRequiredAsyncWithHttpInfo();
                return localVarResponse.Data;
                ...
                /// <exception cref="BlueRain.ID4i.Client.ApiException">Thrown when fails to make API call</exception>
            /// <returns>Task of ApiResponse (bool?)</returns>
                public async System.Threading.Tasks.Task<ApiResponse<bool?>> IsContractRequiredAsyncWithHttpInfo ()
                {
