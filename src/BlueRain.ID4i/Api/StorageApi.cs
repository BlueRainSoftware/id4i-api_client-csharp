...
namespace BlueRain.ID4i.Api
{
    ...
    #region Synchronous Operations
        ...
        /// <param name="content">content</param>
        /// <returns>ApiResponse of Document</returns>
        ApiResponse<Document> PutDocumentWithHttpInfo (string organizationId, string id4n, System.IO.Stream content);
        /// <summary>
        ...
        ApiResponse<Object> WriteToMicrostorageWithHttpInfo (string organization, string id4n, string contentType = null, long? contentLength = null, byte[] body = null);
            ...
            /// <param name="content">content</param>
            /// <returns>Task of Document</returns>
            System.Threading.Tasks.Task<Document> PutDocumentAsync (string organizationId, string id4n, System.IO.Stream content);
            ...
            /// <param name="content">content</param>
            /// <returns>Task of ApiResponse (Document)</returns>
                System.Threading.Tasks.Task<ApiResponse<Document>> PutDocumentAsyncWithHttpInfo (string organizationId, string id4n, System.IO.Stream content);
                /// <summary>
                /// Read document contents
                /// </summary>
                /// <remarks>
    ...
    public partial class StorageApi : IStorageApi
        ...
        this.Configuration.AddDefaultHeader(key, value);
            ...
            /// <summary>
            /// Create an document for an id4n The documents&#39; mime type is suggested on octet-stream data. Otherwise the specified content mime type is used.
            /// </summary>
            /// <exception cref="BlueRain.ID4i.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="organizationId">organizationId</param>
        /// <param name="id4n">id4n</param>
        ...
        /// <returns>ApiResponse of PaginatedResponseOfDocument</returns>
            ...
            /// <summary>
            /// Put an document for an id4n Creating or overwriting an existing document 
            /// </summary>
            /// <exception cref="BlueRain.ID4i.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="organizationId">organizationId</param>
        /// <param name="id4n">id4n</param>
        /// <param name="content">content</param>
        /// <returns>Document</returns>
            public Document PutDocument (string organizationId, string id4n, System.IO.Stream content)
            {
        ApiResponse<Document> localVarResponse = PutDocumentWithHttpInfo(organizationId, id4n, content);
            return localVarResponse.Data;
            }
        ...
        /// <param name="content">content</param>
        /// <returns>ApiResponse of Document</returns>
            public ApiResponse< Document > PutDocumentWithHttpInfo (string organizationId, string id4n, System.IO.Stream content)
            {
                    // verify the required parameter 'organizationId' is set
                    if (organizationId == null)
                    throw new ApiException(400, "Missing required parameter 'organizationId' when calling StorageApi->PutDocument");
                    // verify the required parameter 'id4n' is set
                    if (id4n == null)
                    throw new ApiException(400, "Missing required parameter 'id4n' when calling StorageApi->PutDocument");
                    // verify the required parameter 'content' is set
                    if (content == null)
                    throw new ApiException(400, "Missing required parameter 'content' when calling StorageApi->PutDocument");
            ...
            if (ExceptionFactory != null)
            {
            Exception exception = ExceptionFactory("PutDocument", localVarResponse);
            if (exception != null) throw exception;
            }
            ...
            /// <param name="content">content</param>
            /// <returns>Task of Document</returns>
            public async System.Threading.Tasks.Task<Document> PutDocumentAsync (string organizationId, string id4n, System.IO.Stream content)
                {
            ApiResponse<Document> localVarResponse = await PutDocumentAsyncWithHttpInfo(organizationId, id4n, content);
                return localVarResponse.Data;
            ...
            /// <param name="content">content</param>
            /// <returns>Task of ApiResponse (Document)</returns>
                public async System.Threading.Tasks.Task<ApiResponse<Document>> PutDocumentAsyncWithHttpInfo (string organizationId, string id4n, System.IO.Stream content)
                {
                        // verify the required parameter 'organizationId' is set
                        if (organizationId == null)
                        throw new ApiException(400, "Missing required parameter 'organizationId' when calling StorageApi->PutDocument");
