...
namespace BlueRain.ID4i.Api
{
    ...
    #region Synchronous Operations
        ...
        ApiResponse<PaginatedApiKeyResponse> ListAllApiKeysOfOrganizationWithHttpInfo (long? organizationId, int? offset = null, int? limit = null);
        /// <summary>
            /// List privileges
            /// </summary>
        /// <remarks>
        ...
        ApiResponse<Object> UpdateApiKeyWithHttpInfo (string key, ApiKeyChangeRequest apiKeyChange);
            ...
            System.Threading.Tasks.Task<PaginatedApiKeyResponse> ListAllApiKeysOfOrganizationAsync (long? organizationId, int? offset = null, int? limit = null);
            ...
            /// <returns>Task of ApiResponse (PaginatedApiKeyResponse)</returns>
                System.Threading.Tasks.Task<ApiResponse<PaginatedApiKeyResponse>> ListAllApiKeysOfOrganizationAsyncWithHttpInfo (long? organizationId, int? offset = null, int? limit = null);
                /// <summary>
                /// List privileges
                /// </summary>
                /// <remarks>
    ...
    public partial class ApiKeysApi : IApiKeysApi
        ...
        /// <param name="limit">The maximum count of returned elements (optional)</param>
        /// <returns>PaginatedApiKeyResponse</returns>
            public PaginatedApiKeyResponse ListAllApiKeysOfOrganization (long? organizationId, int? offset = null, int? limit = null)
            {
        ...
        /// <param name="limit">The maximum count of returned elements (optional)</param>
        /// <returns>ApiResponse of PaginatedApiKeyResponse</returns>
            public ApiResponse< PaginatedApiKeyResponse > ListAllApiKeysOfOrganizationWithHttpInfo (long? organizationId, int? offset = null, int? limit = null)
            {
                    // verify the required parameter 'organizationId' is set
                    if (organizationId == null)
                    throw new ApiException(400, "Missing required parameter 'organizationId' when calling ApiKeysApi->ListAllApiKeysOfOrganization");
            ...
            /// <param name="limit">The maximum count of returned elements (optional)</param>
            /// <returns>Task of PaginatedApiKeyResponse</returns>
            public async System.Threading.Tasks.Task<PaginatedApiKeyResponse> ListAllApiKeysOfOrganizationAsync (long? organizationId, int? offset = null, int? limit = null)
                {
            ...
            /// <param name="limit">The maximum count of returned elements (optional)</param>
            /// <returns>Task of ApiResponse (PaginatedApiKeyResponse)</returns>
                public async System.Threading.Tasks.Task<ApiResponse<PaginatedApiKeyResponse>> ListAllApiKeysOfOrganizationAsyncWithHttpInfo (long? organizationId, int? offset = null, int? limit = null)
                {
                        // verify the required parameter 'organizationId' is set
                        if (organizationId == null)
                        throw new ApiException(400, "Missing required parameter 'organizationId' when calling ApiKeysApi->ListAllApiKeysOfOrganization");
