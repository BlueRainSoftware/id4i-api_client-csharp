...
- SDK version: 1.0.0
- Build date: 2018-02-01T08:43:58.354Z
...
## Documentation for Models
 ...
 - [DE.ID4i.Model.Document](docs/Document.md)
 - [DE.ID4i.Model.DocumentUpdate](docs/DocumentUpdate.md)
 ...
 - [DE.ID4i.Model.OwnedDocument](docs/OwnedDocument.md)
 ...
 - [DE.ID4i.Model.PaginatedDocumentResponse](docs/PaginatedDocumentResponse.md)
 ...
 - [DE.ID4i.Model.PaginatedOwnedDocumentResponse](docs/PaginatedOwnedDocumentResponse.md)
 ...
 - [DE.ID4i.Model.PaginatedResponseDocument](docs/PaginatedResponseDocument.md)
 ...
 - [DE.ID4i.Model.PaginatedResponseOwnedDocument](docs/PaginatedResponseOwnedDocument.md)
 ...
 - [DE.ID4i.Model.ServiceCosts](docs/ServiceCosts.md)
